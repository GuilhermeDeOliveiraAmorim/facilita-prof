...
var CreateQuestionUseCase = /** @class */ (function () {
    function CreateQuestionUseCase(teacherGateway) {
        this.teacherGateway = teacherGateway;
    }
    CreateQuestionUseCase.prototype.execute = function (title, content, answer) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.teacherGateway.create(title, content, answer)];
